...
लिखने पर 3D में
    (y₁,y₂,0)=(x,v,0)
दिखता है। यह phase-space trajectory है, particle का literal x-y-z path नहीं। ω=1 और suitable scaling में
    x=A cos t,  v=-A sin t
से
    x²+v²=A²
मिलता है, इसलिए circle आता है; उसके projection में वही familiar one-dimensional oscillation दिख सकती है।

Lorenz में भी (y₁,y₂,y₃) state-space coordinates हैं। दूसरी ओर Two Body और Ballistic जैसे models में जहाँ states actual position coordinates देते हैं, 3D को physical geometry के रूप में पढ़ना अधिक natural है।
